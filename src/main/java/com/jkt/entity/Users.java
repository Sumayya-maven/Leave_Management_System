...
public class Users {
   ...
   //@OneToMany(cascade =CascadeType.ALL)
    //private List <LeavesTrack> leaves;
	...
	public Users(String id, String password, char enabled,
...
/*	public List<LeavesTrack> getLeaves() {
		return leaves;
	}

	public void setLeaves(List<LeavesTrack> leaves) {
		this.leaves = leaves;
	}
*/
	public String getId() {
	...
	public String toString() {
		return "User [id=" + id + ", password=" + password + ", enabled=" + enabled + ", email=" + email
